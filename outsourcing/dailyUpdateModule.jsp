...
<%
    ...
    String schedule_date = request.getParameter("schedule_date_value");
    String schedule_time = request.getParameter("schedule_time_value");
    String schedule_cont = request.getParameter("schedule_cont_value");
    ...
    // Query 문 작성
    String scheduleSql = "UPDATE schedule SET date=?, time=?, content=? WHERE schedule_id=?";
    PreparedStatement scheduleQuery = conn.prepareStatement(scheduleSql);
    scheduleQuery.setString(1, schedule_date);
    scheduleQuery.setString(2, schedule_time);
    scheduleQuery.setString(3, schedule_cont);
    scheduleQuery.setString(4, schedule_id);
